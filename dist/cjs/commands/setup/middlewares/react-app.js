...
const reactDir = path.join((0, os_1.tmpdir)(), 'react-app');
const pkg = {
    dependencies: {
        react: '^18.2.0',
        'react-dom': '^18.2.0',
...
exports.default = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, child_process_1.execSync)('npm install --save-dev create-react-app');
    (0, child_process_1.execSync)(`npx create-react-app ${reactDir} --template typescript --scripts-version ${reactScriptVersion}`);
    (0, child_process_1.execSync)('npm remove create-react-app');
    ...
    const setupTests = fs
        ...
        .toString()
        .replace("import '@testing-library/jest-dom';", "// eslint-disable-next-line import/no-extraneous-dependencies\nimport '@testing-library/jest-dom';");
