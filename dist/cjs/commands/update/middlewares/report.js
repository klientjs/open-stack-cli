...
const getDependencyVersion = (dir, section, target) => {
    ...
    const version = (0, child_process_1.execSync)(`npm pkg get ${section}.${target}`).toString().replace(/\n|"/g, '');
    backToPreviousDir();
...
const buildMarkdownReport = (context) => {
    ...
    const openStackRepo = (0, repository_1.sourceRepositoryToUrl)(repository);
    const currRepository = (0, repository_1.sourceRepositoryToUrl)();
    const currBranch = (0, repository_1.getCurrentBranchName)();
