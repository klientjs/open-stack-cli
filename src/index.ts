...
export default yargs(hideBin(process.argv))
  ...
  .command(
    'update [dir]',
    'Update target dir to specific open-stack version',
    (y) =>
      y
        ...
        .option('dry', { type: 'boolean', description: 'Run with dry mode (read-only mode)', default: false }),
    (args) => execute(update, args)
  )
